// app/projects/stupid-guys/page.tsx
"use client";

import Link from "next/link";
import { ArrowLeft, Github } from "lucide-react";

export default function StupidGuysPage() {
  return (
        ...
        <div className="max-w-5xl w-full space-y-8">
          ...
          <header className="text-left">
            ...
            <p className="text-xl text-gray-600 mb-2">
              멀티플레이어 파티 게임(폴가이즈 모작)
            </p>
            <p className="text-gray-500 font-mono">2025.12 - 2026.01</p>
          </header>
          ...
          <section className="mb-12">
            <div className="aspect-video bg-gray-900 rounded-lg overflow-hidden mb-4">
              <video className="w-full h-full" controls muted>
                <source src="/videos/StupidGuysPlay.mp4" type="video/mp4" />
              </video>
            </div>
          </section>
          ...
          <section>
            <div className="flex justify-center">
              <a
                href="https://github.com/Troutverse/StupidGuys"
                target="_blank"
