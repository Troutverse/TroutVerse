    ...
    <div className="w-full h-full flex items-center justify-between px-12 gap-8">
      ...
      >
        ...
        <p className="text-lg text-gray-300 font-mono leading-relaxed">
          Unity VR 환경에서 실시간으로 작동하는 Cap Mesh 생성 시스템입니다. 
          <span className="text-cyan-400"> Arc-Length 정렬</span>을 활용한 
          자연스러운 <span className="text-purple-400">삼각형 메쉬 생성</span>이 적용되었습니다.
        </p>

        {/* GitHub 버튼 */}
        <motion.a
          href="https://github.com/Troutverse/MeshCreation"
          target="_blank"
        ...
        <div className="flex flex-wrap gap-2 mt-2">
          {['Unity', 'C#', 'VR', 'Triangulation'].map((tech, i) => (
            <span
              key={tech}
        ...
        <div className="mt-4 p-4 bg-black/30 backdrop-blur-sm border border-green-500/30 rounded-lg">
          ...
          <div className="grid grid-cols-2 gap-3 text-sm font-mono">
            <div>
              ...
              <span className="text-white ml-2 font-bold">~1ms</span>
            </div>
            <div>
            ...
            <div>
              ...
              <span className="text-white ml-2">Arc-Length</span>
            </div>
            <div>
              <span className="text-gray-400">시도 횟수:</span>
              <span className="text-cyan-400 ml-2 font-bold">3회</span>
            </div>
          </div>
        </div>
      </motion.div>
