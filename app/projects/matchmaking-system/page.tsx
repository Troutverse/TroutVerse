  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <section className="mb-12">
          <div className="aspect-video bg-gray-900 rounded-lg overflow-hidden mb-4">
            <video className="w-full h-full" controls>
              <source src="/videos/matchmaking-demo.mp4" type="video/mp4" />
            </video>
          </div>
        </section>
        ...
        <section className="mb-12">
          <a
            href="https://github.com/Troutverse/MatchmakingSystem"
            target="_blank"
        ...
        <section className="mb-12">
          ...
          <div className="flex flex-wrap gap-2">
            {["Unity", "C#", "SignalR", "ASP.NET Core", "WebSocket", "Render.com", "Docker"].map(
              (tech) => (
                <span
                  key={tech}
        ...
        <section className="mb-12">
          ...
          <div className="prose prose-gray max-w-none">
            <p className="text-gray-700 leading-relaxed mb-4">
              VR 멀티플레이어 게임에서 4인 실시간 매칭 시스템을 구현하는 것이 목표였습니다. 
              플레이어들이 빠르고 안정적으로 매칭되어 게임을 시작할 수 있도록 하는 것이 핵심이었습니다.
            </p>
            <p className="text-gray-700 leading-relaxed mb-4">
              Unity의 기본 Netcode for GameObjects는 매칭 기능을 제공하지 않기 때문에, 
              별도의 매칭 서버를 구축해야 했습니다. SignalR을 사용하여 WebSocket 기반의 
              실시간 양방향 통신을 구현하고, 안정적이고 확장 가능한 매칭 시스템을 완성했습니다.
            </p>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              ...
              플레이어들을 매칭하는 기능은 제공하지 않습니다. 즉, 게임 세션이 시작되기 전에 
              플레이어들을 모으고 로비를 관리하는 별도의 시스템이 필요했습니다.
            </p>
            <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
              ...
              <li>
                실시간 통신 필요: 매칭 상태를 실시간으로 동기화해야 함
              </li>
            </ul>
          </div>
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              안정적이고 확장 가능한 매칭 시스템을 만들기 위해서는 다음과 같은 요구사항이 있었습니다:
            </p>
            <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
          ...
          <div className="bg-gray-50 border-l-4 border-blue-500 p-6 rounded-r">
            ...
            <p className="text-gray-700">
              ...
              ASP.NET Core 서버에서 로비를 관리하여 안정적이고 확장 가능한 
              매칭 시스템을 구축했습니다.
            </p>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-700 leading-relaxed mb-8">
            완벽한 시스템을 구축하기까지 여러 기술적 도전과제를 마주했고, 
            각각에 대한 해결책을 찾아 적용했습니다.
          </p>
          ...
          <div className="mb-10">
            ...
            <div className="pl-11">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                플레이어가 갑자기 게임을 종료하거나 네트워크가 끊겼을 때, 
                해당 플레이어가 로비에 그대로 남아있는 문제가 발생했습니다. 
                이로 인해 다른 플레이어들은 4명이 다 모였다고 착각하고 무한정 대기하게 되었고, 
                실제로는 절대 매칭이 완료되지 않았습니다.
              </p>

              <p className="text-gray-700 mb-3 font-medium">해결 방법:</p>
              <p className="text-gray-700 leading-relaxed mb-4">
                SignalR의 OnDisconnectedAsync 메서드를 오버라이드하여 
                플레이어의 연결이 끊어질 때 자동으로 로비에서 제거하고, 
                다른 플레이어들에게 즉시 알림을 보내도록 구현했습니다.
              </p>

              <CodeSnippet code={`public override async Task OnDisconnectedAsync(Exception? ex)
{
    ...
    await base.OnDisconnectedAsync(ex);
              ...
              <p className="text-gray-700">
                자동 정리 메커니즘으로 메모리 누수를 방지하고, 
                다른 플레이어들이 무한 대기하는 상황을 해결했습니다.
              </p>
            </div>
          </div>
          ...
          <div className="mb-10">
            ...
            <div className="pl-11">
              <p className="text-gray-700 mb-3 font-medium">문제 상황:</p>
              <p className="text-gray-700 leading-relaxed mb-4">
                SignalR 콜백은 백그라운드 스레드에서 실행되는데, 
                Unity API는 반드시 메인 스레드에서만 호출되어야 합니다. 
                이로 인해 SignalR 콜백에서 UI를 업데이트하려고 할 때 
                UnityException이 발생했습니다.
              </p>
              ...
              <CodeSnippet code={`// UnityMainThreadDispatcher.cs
...
_connection.On<LobbyStatus>("LobbyUpdated", (status) =>
{
    ...
    UnityMainThreadDispatcher.Enqueue(() =>
    {
        ...
        OnLobbyUpdated?.Invoke(status);
              ...
              <p className="text-gray-700 mb-3 font-medium">결과:</p>
              <p className="text-gray-700">
                Thread-safe한 Unity API 호출을 보장하여 예외 발생을 완전히 제거했습니다.
              </p>
            </div>
          </div>
          ...
          <div className="mb-10">
            ...
            <div className="pl-11">
              <p className="text-gray-700 mb-3 font-medium">문제 상황:</p>
              <p className="text-gray-700 leading-relaxed mb-4">
                여러 클라이언트가 동시에 같은 로비에 입장을 시도할 때, 
                Race Condition이 발생했습니다. 예를 들어 3명이 있는 4인 로비에 
                두 명이 동시에 입장하려고 하면, 둘 다 "3명이네, 입장 가능해!"라고 
                판단하여 5명이 4인 로비에 들어가는 데이터 무결성 문제가 발생했습니다.
              </p>

              <p className="text-gray-700 mb-3 font-medium">해결 방법:</p>
              <p className="text-gray-700 leading-relaxed mb-4">
                Lock 문과 ConcurrentDictionary를 조합하여 Thread-safe한 
                로비 관리를 구현했습니다. Lock으로 로비 내부 상태 변경을 보호하고, 
                ConcurrentDictionary로 여러 로비에 대한 동시 접근을 안전하게 처리했습니다.
              </p>

              <CodeSnippet code={`// Lobby.cs - 내부 상태 보호
public class Lobby
{
    ...
    public Lobby? FindLobby()
    {
        ...
        return _lobbies.Values
            .FirstOrDefault(l => !l.IsFull);
              ...
              <p className="text-gray-700">
                ...
                동시에 100명 이상의 플레이어가 접속해도 안정적으로 동작하도록 만들었습니다.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            모든 도전과제를 해결하여 완성된 실시간 매칭 시스템의 핵심 구성 요소입니다.
          </p>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  SignalR을 사용하여 클라이언트와 서버 간 실시간 양방향 통신을 구현했습니다. 
                  WebSocket 프로토콜을 통해 100ms 이내의 빠른 응답 시간을 달성했고, 
                  자동 재연결 기능으로 네트워크 불안정 상황에서도 안정적인 서비스를 제공합니다.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  먼저 생성된 로비에 우선적으로 플레이어를 배정하는 FIFO(First In First Out) 방식을 
                  채택했습니다. FindLobby()로 입장 가능한 로비를 찾고, 없으면 CreateLobby()로 
                  새 로비를 생성합니다. 4명이 모이면 즉시 게임이 시작됩니다.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  ConcurrentDictionary로 여러 로비를 안전하게 관리하고, 
                  각 로비 내부에서는 Lock을 사용하여 멤버 추가/제거를 원자적으로 처리합니다. 
                  이를 통해 동시에 수백 명의 플레이어가 접속해도 데이터 무결성을 보장합니다.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  SignalR Groups 기능을 활용하여 로비별로 메시지를 브로드캐스트합니다. 
                  한 플레이어가 입장하거나 퇴장할 때 같은 로비의 모든 플레이어에게 
                  즉시 상태 업데이트가 전달되어, 실시간으로 동기화된 매칭 경험을 제공합니다.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-8">
            <h3 className="text-xl font-bold text-gray-900 mb-4">매칭 플로우</h3>
            <ol className="list-decimal list-inside text-gray-700 space-y-3">
              <li>
                <strong>Connect:</strong> Unity 클라이언트가 SignalR 서버에 WebSocket 연결
              </li>
              <li>
                <strong>Find/Create Lobby:</strong> 입장 가능한 로비를 찾거나 새로 생성
              </li>
              <li>
                <strong>Join Queue:</strong> 로비에 입장하고 SignalR Groups에 추가
              </li>
              <li>
                <strong>Waiting:</strong> 다른 플레이어들이 입장할 때까지 대기, 실시간 상태 수신
              </li>
              <li>
                <strong>Match Found:</strong> 4명이 모두 모이면 OnMatchFound 이벤트 발생
              </li>
              <li>
          ...
          <div className="mb-8">
            ...
            <h4 className="font-semibold text-gray-900 mb-3">MatchmakingHub (서버)</h4>
            <CodeSnippet code={`public class MatchmakingHub : Hub
{
    ...
    private async Task NotifyLobbyUpdated(Lobby lobby)
    {
        await Clients.Group(lobby.Id.ToString())
            ...
            <h4 className="font-semibold text-gray-900 mb-3 mt-6">MatchmakingClient (Unity)</h4>
            <CodeSnippet code={`public class MatchmakingClient : MonoBehaviour
{
    ...
    public async Task StartMatchmakingAsync()
    {
        await _connection.InvokeAsync("FindOrCreateLobby");
          ...
          <div className="bg-green-50 border-l-4 border-green-500 p-6 rounded-r">
            ...
            <p className="text-gray-700 mb-3">
              SignalR의 실시간 통신 능력과 Thread-Safe한 데이터 관리, 
              그리고 Unity와의 완벽한 통합이 시스템 성공의 핵심이었습니다.
            </p>
            <p className="text-gray-700">
        ...
        <section className="mb-12">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              SignalR은 ASP.NET Core의 실시간 통신 라이브러리로, 
              WebSocket을 기본으로 사용하되 클라이언트가 WebSocket을 지원하지 않으면 
            ...
            <CodeSnippet code={`// Unity 클라이언트 연결 설정
...
connection.Reconnected += connectionId =>
{
    ...
    return Task.CompletedTask;
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              멀티스레드 환경에서 안전한 데이터 처리를 위해 여러 동시성 제어 기법을 사용했습니다.
            </p>

            <h4 className="font-semibold text-gray-900 mb-3">1. ConcurrentDictionary</h4>
            <p className="text-gray-700 leading-relaxed mb-3">
              여러 스레드에서 동시에 로비 컬렉션에 접근할 수 있도록 
              Thread-safe한 Dictionary를 사용했습니다.
            </p>
            <CodeSnippet code={`public class LobbiesManager
{
    private readonly ConcurrentDictionary<int, Lobby> _lobbies 
        = new ConcurrentDictionary<int, Lobby>();
    ...
    public void RemoveLobby(int lobbyId)
    {
        ...
        _lobbies.TryRemove(lobbyId, out _);
            ...
            <h4 className="font-semibold text-gray-900 mb-3 mt-6">2. Lock Statement</h4>
            <p className="text-gray-700 leading-relaxed mb-3">
              로비 내부의 멤버 리스트를 수정할 때는 Lock을 사용하여 
              한 번에 하나의 스레드만 접근하도록 보장했습니다.
            </p>
            <CodeSnippet code={`public class Lobby
{
    private readonly object _gate = new object();
    private readonly HashSet<string> _members = new HashSet<string>();
    ...
    public int MemberCount
    {
        get
        {
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Unity는 싱글스레드 환경이지만 SignalR 콜백은 백그라운드 스레드에서 실행됩니다. 
              이 문제를 해결하기 위해 MainThreadDispatcher 패턴을 구현했습니다.
            </p>

            <CodeSnippet code={`public class UnityMainThreadDispatcher : MonoBehaviour
{
    private static UnityMainThreadDispatcher _instance;
    private readonly Queue<Action> _executionQueue = new Queue<Action>();
    ...
    void Update()
    {
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="border border-gray-200 rounded-lg p-6 text-center">
              <p className="text-4xl font-bold text-green-600 mb-2">&lt;100ms</p>
          ...
          <div>
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-3">
              <li>
                <strong>실시간 통신 아키텍처:</strong>{" "}
                SignalR을 활용한 WebSocket 기반 양방향 통신 시스템 설계 및 구현
              </li>
              <li>
                <strong>동시성 제어 패턴:</strong>{" "}
                Lock과 ConcurrentDictionary를 통한 Thread-safe 구현 경험
              </li>
              <li>
                <strong>클라우드 배포 경험:</strong>{" "}
                Docker와 Render.com을 활용한 프로덕션 환경 배포
              </li>
              <li>
                <strong>Unity와 서버 통합:</strong>{" "}
                크로스 플랫폼 실시간 통신 구현 및 스레드 안정성 확보
              </li>
            </ul>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-3">
            ...
            <li>
              <strong>매칭 히스토리 대시보드:</strong> 매칭 패턴 분석 및 
              시스템 모니터링을 위한 분석 도구 개발
            </li>
            <li>
              <strong>글로벌 리전 지원:</strong> 지역별 서버 배치로 
              전세계 플레이어의 레이턴시 최적화
            </li>
          </ul>
        </section>
